# -*- coding: utf-8 -*-
"""Unfreezed - Combined Model with Adam.ipynb
...
!unzip /content/drive/MyDrive/Thesis/Dataset/ResizedImages
...
def makeModel(modelfunction):
  ...
  if(modelfunction.__name__ == 'ResNet152V2'):
    for layer in pre_trained_model.layers[:-36]:
      layer.trainable = False

  if(modelfunction.__name__ == 'EfficientNetB2'):
    for layer in pre_trained_model.layers[:-31]:
      layer.trainable = False

  if(modelfunction.__name__ == 'EfficientNetB5'):
    for layer in pre_trained_model.layers[:-44]:
      layer.trainable = False
...
modelPath = "/content/drive/MyDrive/Thesis/ResNet152V2/UnFreezed-ResNet152V2-with-Adam.h5"

pre_trained_model.summary()

model = addTopLayers(pre_trained_model)

print(model.get_layer('conv4_block36_out').trainable)
model.get_layer('conv5_block1_preact_bn').trainable
...
modelPath = "/content/drive/MyDrive/Thesis/VGG16/VGG16-with-Adam.h5"
...
modelPath = "/content/drive/MyDrive/Thesis/VGG19/VGG19-with-Adam.h5"
...
modelPath = "/content/drive/MyDrive/Thesis/EfficientNetB2/UnFreezed-EfficientNetB2-with-Adam.h5"
...
print(model.get_layer('block6e_drop').trainable)
model.get_layer('block7a_expand_conv').trainable

# model.layers['block7a_expand_conv']
...
modelPath = "/content/drive/MyDrive/Thesis/EfficientNetB5/UnFreezed-EfficientNetB5-with-Adam.h5"
